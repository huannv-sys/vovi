      ...
      <div className="overflow-y-auto flex-grow">
        <nav className="mt-2 px-2">
          <div className="mb-4">
            ...
            <Link href="/" className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${isActive('/') ? 'bg-primary bg-opacity-10 text-primary border-l-4 border-primary' : 'text-neutral-dark hover:bg-gray-100'}`}>
          ...
          <div className="mb-4">
            ...
            <Link href="/security" className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${isActive('/security') ? 'bg-primary bg-opacity-10 text-primary border-l-4 border-primary' : 'text-neutral-dark hover:bg-gray-100'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive('/security') ? 'text-primary' : 'text-gray-500'} ${collapsed ? 'mx-auto' : 'mr-3'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="mb-4">
            ...
            <Link href="/devices" className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${isActive('/devices') ? 'bg-primary bg-opacity-10 text-primary border-l-4 border-primary' : 'text-neutral-dark hover:bg-gray-100'}`}>
            ...
            <Link href="/alerts" className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${isActive('/alerts') ? 'bg-primary bg-opacity-10 text-primary border-l-4 border-primary' : 'text-neutral-dark hover:bg-gray-100'}`}>
            ...
            <Link href="/settings" className={`flex items-center px-3 py-2 text-sm font-medium rounded-md ${isActive('/settings') ? 'bg-primary bg-opacity-10 text-primary border-l-4 border-primary' : 'text-neutral-dark hover:bg-gray-100'}`}>
              <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${isActive('/settings') ? 'text-primary' : 'text-gray-500'} ${collapsed ? 'mx-auto' : 'mr-3'}`} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
